 ...
 * large recording this transiently needs ~2x the file size in the main process
 * and can crash it on a memory-constrained machine. So the safe cutoff is far
 * below the 2 GiB read cap.
 *
