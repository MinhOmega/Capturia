...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.uploadJpgOnly": "Please upload a JPG or PNG image file.",
    ...
    "shortcut.copySelected": "Copy Selected",
  ...
  "zh-CN": {
    ...
    "settings.uploadJpgOnly": "请上传 JPG 或 PNG 图片文件。",
