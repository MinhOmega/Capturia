...
/**
 * Sanitises free-form speed input while the user types: keeps digits and a
 * single decimal point (comma accepted as decimal separator) and classifies
 * the result against the editor's speed range.
 */
