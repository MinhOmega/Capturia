      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm font-medium text-slate-200">
            {t('settings.annotation.settings')}
          </span>
        ...
        >
          ...
          <TabsContent value="text" className="mt-0 space-y-4">
            <div>
              <label className="text-xs font-medium text-slate-200 mb-2 block">
                {t('settings.annotation.textContent')}
              </label>
              <textarea
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="text-xs font-medium text-slate-200 mb-2 block">
                    {t('settings.annotation.fontStyle')}
                  </label>
                  <Select
              ...
              <div>
                <label className="text-xs font-medium text-slate-200 mb-2 block">
                  {t('settings.annotation.textAnimation')}
                </label>
                <Select
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-medium text-slate-200 mb-2 block">
                    {t('settings.annotation.textColor')}
                  </label>
                  <Popover>
                ...
                <div>
                  <label className="text-xs font-medium text-slate-200 mb-2 block">
                    {t('settings.annotation.background')}
                  </label>
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                      ...
                      >
                        ...
                        <span className="text-xs text-slate-300 truncate flex-1 text-left">
                          {annotation.style.backgroundColor === 'transparent'
                            ? t('settings.annotation.none')
                            : t('settings.annotation.color')}
                        </span>
                        <ChevronDown className="h-3 w-3 opacity-50" />
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-[260px] p-3 bg-[#1a1a1c] border border-white/10 rounded-xl shadow-xl">
                      <ColorPicker
                        ...
                        translations={{
                          ...
                          clearBackground: t('settings.annotation.clearBackground'),
                        }}
                      />
                    </PopoverContent>
                  </Popover>
          ...
          <TabsContent value="image" className="mt-0 space-y-4">
            ...
            {annotation.content && annotation.content.startsWith('data:image') && (
              <div className="rounded-lg border border-white/10 overflow-hidden bg-white/5 p-2">
                <img
                  ...
                  alt={t('settings.annotation.uploadedImage')}
            ...
            <p className="text-xs text-slate-500 text-center leading-relaxed">
              {t('settings.annotation.supportedFormats')}
            </p>
          </TabsContent>
          ...
          <TabsContent value="figure" className="mt-0 space-y-4">
            <div>
              <label className="text-xs font-medium text-slate-200 mb-3 block">
                {t('settings.annotation.arrowDirection')}
              </label>
            ...
            <div>
              <label className="text-xs font-medium text-slate-200 mb-2 block">
                {t('settings.annotation.strokeWidth', {
            ...
            <div>
              <label className="text-xs font-medium text-slate-200 mb-2 block">
                {t('settings.annotation.arrowColor')}
              </label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button
