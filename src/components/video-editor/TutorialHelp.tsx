    ...
    <Dialog>
      <DialogTrigger asChild>
        ...
        >
          ...
          <span className="font-medium">{t('dialogs.tutorial.trigger')}</span>
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-2xl bg-[#09090b] border-white/10 [&>button]:text-slate-400 [&>button:hover]:text-white">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold text-slate-200 flex items-center gap-2">
            <Scissors className="w-5 h-5 text-[#ef4444]" /> {t('dialogs.tutorial.title')}
          </DialogTitle>
          <DialogDescription className="text-slate-400">
            {t('dialogs.tutorial.desc')}
          </DialogDescription>
        </DialogHeader>
        <div className="mt-4 space-y-8">
          {/* Explanation */}
          <div className="bg-white/5 rounded-lg p-4 border border-white/5">
            <p className="text-slate-300 leading-relaxed">{t('dialogs.tutorial.explain')}</p>
          </div>
          {/* Visual Illustration */}
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-slate-400 uppercase tracking-wider">
              {t('dialogs.tutorial.visualExample')}
            </h3>
            ...
            <div className="relative h-12 bg-[#000] rounded-lg border border-white/10 flex items-center justify-center gap-1 px-4 select-none">
              ...
              >
                <span className="text-[10px] text-white font-medium">
                  {t('dialogs.tutorial.part', { index: 1 })}
                </span>
              </div>
              <div
                className="h-8 bg-slate-700 rounded flex items-center justify-center opacity-80"
              ...
              >
                <span className="text-[10px] text-white font-medium">
                  {t('dialogs.tutorial.part', { index: 2 })}
                </span>
              </div>
              <div
                className="h-8 bg-slate-700 rounded flex items-center justify-center opacity-80"
              ...
              >
                <span className="text-[10px] text-white font-medium">
                  {t('dialogs.tutorial.part', { index: 3 })}
                </span>
              </div>
              <span className="absolute right-4 text-xs text-slate-400">
                {t('dialogs.tutorial.finalVideo')}
              </span>
            </div>
          </div>
          {/* Steps */}
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 rounded bg-white/5 border border-white/5">
              <div className="text-[#ef4444] font-bold mb-1">{t('dialogs.tutorial.step1')}</div>
              <p className="text-xs text-slate-400">{t('dialogs.tutorial.step1desc')}</p>
            </div>
            <div className="p-3 rounded bg-white/5 border border-white/5">
              <div className="text-[#ef4444] font-bold mb-1">{t('dialogs.tutorial.step2')}</div>
              <p className="text-xs text-slate-400">{t('dialogs.tutorial.step2desc')}</p>
            </div>
          </div>
        </div>
      </DialogContent>
