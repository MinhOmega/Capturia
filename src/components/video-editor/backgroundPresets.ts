/**
 * Gradient presets offered in the background picker. Kept in a plain module so
 * the exporter's gradient parser can be regression-tested against every preset
 * without importing the SettingsPanel component.
 */
export const BACKGROUND_GRADIENT_PRESETS: readonly string[] = [
