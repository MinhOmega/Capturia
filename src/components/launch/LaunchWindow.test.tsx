	...
	useScopedT: () => (key: string, vars?: Record<string, string | number>) => {
		const translations: Record<string, string> = {
			...
			"systemLanguagePrompt.description":
				"We detected English as your system language. Do you want to switch Capturia to English?",
			...
			"softwareEncoderFallback.description":
				"The default GPU encoder failed to start, so Capturia fell back to software H.264 encoding. Recording should continue as normal, but CPU usage may be higher.",
